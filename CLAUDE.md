...
This file is loaded into every Claude Code session for this project. It captures the stack, conventions, and pointers to the deeper documentation so Claude has the context it needs from the first turn.
...
This project uses Claude Code subagents and skills for consistent frontend work.
